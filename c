...
CONFIG_DEFAULT_coreutils=y
CONFIG_DEFAULT_coreutils-nohup=y
...
CONFIG_DEFAULT_libcap=y
CONFIG_DEFAULT_libcap-bin=y
...
CONFIG_DEFAULT_ruby=y
CONFIG_DEFAULT_ruby-yaml=y
...
# CONFIG_SQUASHFS_TOOLS_ZSTD_SUPPORT is not set
...
CONFIG_OVERRIDE_PKGS="luci-app-amlogic"
